package br.com.cwi.cursoandroid.locadoraroots.activities;
...
public class AuthActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        containerAuth = findViewById(R.id.container_auth);
    }
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Snackbar.make(containerAuth, "Falha de autenticação", Snackbar.LENGTH_LONG).show();
                        }
                    }
                });
    }
